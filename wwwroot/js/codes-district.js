...
$(function () {
    ...
    var dt_codes_table = $('.datatables-districts'), //name of the table
    ...
    if (dt_codes_table.length) {
        var dt_codes = dt_codes_table.DataTable({
            ajax: assetsPath + 'json/codes-districts.json', // JSON file to add data
            columns: [
            ...
            columnDefs: [{
...

                {
                    targets: 4,
                    render: function (data, type, full, meta) {
                        var $courtOfAppeal = full['courtOfAppeal'];
...

                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            '<a href="javascript:;" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEditDistrict"' +
            ...
            buttons: [

                {
                    ...
                    attr: {
                        ...
                        'data-bs-target': '#offcanvasAddDistrict'
                    }
                }
            ],
    ...
    // Delete Record
    $('.datatables-districts tbody').on('click', '.delete-record', function () {
...
(function () {
    ...
    const fv = FormValidation.formValidation(AddDistrictForm, {
        fields: {
            Name: {
             validators: {
              notEmpty: {
                message: 'الرجاء إدخال اسم المديرية  '
                    }
                }
            }
        },
