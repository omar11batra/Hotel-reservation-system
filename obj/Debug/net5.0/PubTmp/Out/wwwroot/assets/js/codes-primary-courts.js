...
$(function () {
    ...
    var dt_codes_table = $('.datatables-primaryCourts'), //name of the table
    ...
    if (dt_codes_table.length) {
        var dt_codes = dt_codes_table.DataTable({
            ajax: assetsPath + 'json/codes-courts-primary.json', // JSON file to add data
            columns: [
...

                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            '<a href="javascript:;" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEditPrimaryCourt"' +
            ...
            buttons: [

                {
                    ...
                    attr: {
                        ...
                        'data-bs-target': '#offcanvasAddPrimaryCourt'
                    }
                }
            ],
    ...
    // Delete Record
    $('.datatables-primaryCourts tbody').on('click', '.delete-record', function () {
...
// Validation 
(function () {
    var AddCourtForm = document.getElementById('AddPrimaryCourtForm');
    ...
    const fv = FormValidation.formValidation(AddCourtForm, {
        fields: {
            Name: {
             validators: {
              notEmpty: {
                message: 'الرجاء إدخال اسم المحكمة الإبتدائية'
                    }
                }
            }
        },
