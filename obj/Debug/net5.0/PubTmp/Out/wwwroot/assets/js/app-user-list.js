  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      dom:
        '<"row mx-2"' +
        '<"col-md-2"<"me-3"l>>' +
        '<"col-md-10"<"dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0"Bf>>' +
        '>t' +
        '<"row mx-2"' +
      ...
      buttons: [
        ...
        },
        {
          ...
          attr: {
            'onclick':'window.location.href="auth-register-multisteps.html";'
